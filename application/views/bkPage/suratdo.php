    ...
    <div id="body">
      <table cellpadding="0" cellspacing="0" width="740">
        ...
        <tr>
          <td>Hal</td>
          <td>:</td>
          <td colspan="3">Pemberitahuan Pengembalian ke Orangtua</td>
        </tr>
      ...
      <table cellspacing="0" cellpading="0">
        ...
        <tr><td colspan="4">&nbsp;</td></tr>
        <tr><td colspan="4">Maka kami memberitahukan kepada bpk/ibu wali siswa dari <?php echo $nama?> bahwa siswa tersebut di atas akan dikembalikan kepada orang tua dalam jangka waktu yang tidak ditentukan sehubungan dengan terjadinya pelanggaran yang cukup sering/besar yang dilakukan oleh siswa tersebut.<br>
